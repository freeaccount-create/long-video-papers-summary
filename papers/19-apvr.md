# 19 · APVR（Adaptive Pivot Visual Information Retrieval，免训练小时级长视频理解）
...
2. **语义扩展**：LLM 输出 Key Objects=person/dog/red clothes，Cue=grassy area/leash/fence，Rel=(person;attribute;red clothes)、(person;spatial;dog)，Sem="leash often appears with dog"（Sem 此处为论文通用示例填入，Fig.5 该样本响应中 Sem 为占位符）。
