...
class LongVideoBenchDataset(BaseVideoEvalDataset):
    ...
    def load_data(self, data_root: str) -> Dict[int, Any]:
        ...
        for record in records:
            ...
            option_letters = [". ".join([chr(ord("A") + i), candidate]) for i, candidate in enumerate(list(record["candidates"]))]
            # e.g., ['A. Raw meat chunk', 'B. White sugar', 'C. Used oil', 'D. White vinegar', 'E. Half a lime']
            ...
            meta_data = {
                ...
                "option_letters_full": option_letters,  # added for attention knockout
                # "subtitle": subtitle,
                "subtitle": [], # for attention knockout only
