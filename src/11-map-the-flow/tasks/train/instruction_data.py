...
anno_root_it = "workspace/annotations/VideoChat2-IT-clean"
...
available_corpus["videochat2_video"] = [
    ...
    available_corpus["vqa_tgif_frame_qa"],
    available_corpus["vqa_tgif_transition_qa"],
    available_corpus["conversation_videochat1"],    # webvid
    available_corpus["vqa_webvid_qa"],  # webvid
    available_corpus["caption_videochat"],  # webvid
    available_corpus["caption_webvid"], # webvid
]
